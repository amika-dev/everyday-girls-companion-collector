...
namespace EverydayGirlsCompanionCollector.Services
{
    ...
    {
        /// <summary>
        /// Returns a paged list of companions in a friend's collection with the specified sort order.
        /// </summary>
        ...
        /// <param name="sort">Sort mode: "bond" (default), "oldest", or "newest".</param>
