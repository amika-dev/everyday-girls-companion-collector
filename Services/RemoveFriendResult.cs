...
{
    /// <summary>
    /// Result of a friend-remove attempt.
    /// Use <see cref="CreateSuccess"/> and <see cref="CreateFailure"/> factory methods to construct.
    /// </summary>
    public record RemoveFriendResult
    {
        /// <summary>
        /// True if the friendship was removed successfully.
        /// </summary>
        ...
        /// </summary>
        public static RemoveFriendResult CreateSuccess() => new() { Success = true };

        /// <summary>
        /// Creates a failed result with a code and message.
        /// </summary>
        public static RemoveFriendResult CreateFailure(string code, string message) =>
